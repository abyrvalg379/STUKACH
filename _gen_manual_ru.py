...
p(doc, '42 чека в 7 категориях + Scene Units. Состав и критичность соответствуют коду v1.8.0; '
       ...
       'фасок для Hard Edges).')
p(doc, 'Preferences - Updates: проверка новой версии (кнопка + ежедневная автопроверка, '
       'отключаемая). При доступном обновлении бейдж в панели ведёт на страницу релиза.')
